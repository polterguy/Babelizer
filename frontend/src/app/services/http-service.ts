...
export class HttpService {
  ...
  translations_Delete(args: any) {
    return this.httpClient.delete<any>(environment.apiUrl + 'magic/modules/babelizer/translations' + this.getQueryArgs(args));
  }

  translations_Get(args: any) {
    return this.httpClient.get<any>(environment.apiUrl + 'magic/modules/babelizer/translations' + this.getQueryArgs(args));
  }

  translations_Post(args: any) {
    return this.httpClient.post<any>(environment.apiUrl + 'magic/modules/babelizer/translations', args);
  }

  translations_Put(args: any) {
    return this.httpClient.put<any>(environment.apiUrl + 'magic/modules/babelizer/translations', args);
  }

  translations_count_Get(args: any) {
    return this.httpClient.get<any>(environment.apiUrl + 'magic/modules/babelizer/translations-count' + this.getQueryArgs(args));
  }
}
