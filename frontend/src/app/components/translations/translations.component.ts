...
export class TranslationsComponent implements OnInit {
  ...
  private displayedColumns: string[] = ['id', 'locale', 'text', 'delete-instance'];
  ...
  ngOnInit() {
    ...
    this.id.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter['id.like'] = this.id.value + '%';
        this.getData();
      });
    this.locale = new FormControl('');
    this.locale.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['locale.like'] = this.locale.value + '%';
        this.getData();
      });
    ...
    this.text.valueChanges
      ...
      .subscribe(query => {
        ...
        this.filter.offset = 0;
        this.hasFiltered = true;
        this.filter['text.like'] = this.text.value + '%';
        this.getData();
      });
  }
  ...
  getData(countRecords: boolean = true) {
    ...
    this.httpService.translations_Get(this.filter).subscribe(res => {
      this.data = res;
      ...
      if (countRecords) {
        ...
        this.httpService.translations_count_Get(cloned).subscribe(res2 => {
  ...
  editDetails(entity: any) {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.snackBar.open('Translations item successfully updated', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  createNewRecord() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.getData();
        this.snackBar.open('Translations item successfully created', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  delete(entity: any, ids: any) {
    ...
    this.httpService.translations_Delete(ids).subscribe(res => {
